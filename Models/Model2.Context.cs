...
namespace DevFolio.Models
{
    ...
    public partial class DbDevFolioEntities7 : DbContext
    {
        public DbDevFolioEntities7()
            : base("name=DbDevFolioEntities7")
        {
        }
        ...
        public virtual ObjectResult<string> GetLastServiceTitle()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("GetLastServiceTitle");
        }
